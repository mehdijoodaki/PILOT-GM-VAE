...
class LossFunctions:
   ...
   #Cross-Entropy Loss: measures the difference between two probability distributions: the true distribution (target,ground truth) and the predicted distribution (model output)
